...
<div class="card">
    <div class="card-header">
        ...
        <a href="<?= base_url('kelas11/print') ?>" class="btn btn-info btn-sm"><i class="fas fa-print"></i> Print </a>
        <a href="<?= base_url('kelas11/pdf') ?>" class="btn btn-success btn-sm"><i class="fas fa-file"></i> Export PDF </a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
                ...
                <tbody>
                    <tr align="center">
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('kelas11/delete/' . $kl->id_siswa) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                </tbody>
            <?php endforeach ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('kelas11/tambah_aksi') ?>" method="POST">
    ...
    <div class="modal fade" id="edit<?= $kl->id_siswa ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('kelas11/edit/' . $kl->id_siswa) ?>" method="POST">
                        <div class="form-group">
                            <label>NISN</label>
