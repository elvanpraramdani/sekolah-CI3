...
class Kelas11 extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('M_kelas11');
        $this->load->helper('url');
    }

    public function index()
    {
        $data['title'] = 'Data Siswa Kelas 11';
        $data['kelas11'] = $this->M_kelas11->get_data('tb_kelas11')->result();

        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('kelas11/v_kelas11', $data);
    ...
    public function tambah_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_kelas11->insert_data($data, 'tb_kelas11');
    ...
    public function edit($id_siswa)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_kelas11->update_data($data, 'tb_kelas11');
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    public function delete($id_siswa)
    {
        ...
        $this->M_kelas11->delete($where, 'tb_kelas11');
